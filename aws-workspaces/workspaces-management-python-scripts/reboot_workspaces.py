...
workspace_id = raw_input("\n"+"Enter the workspace id of the workspace you want to REBOOT: ")
...
if status_code == 200:
  print("\n"+"Workspace REBOOT has been initiated successfully,please wait for couple of minutes for it to complete") 
else:
  print("\n"+"Workspace hasn't been able to reboot successfully,please start it from the aws console")
